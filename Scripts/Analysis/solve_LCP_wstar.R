...
#load rasters
x_1990 <- rast(file.path(path_analysis_data_rast,"x_1990.tif"))/xfactINTS
...
x_2020 <- rast(file.path(path_analysis_data_rast,"x_2020.tif"))/xfactINTS
...
x_2100 <- rast(file.path(path_analysis_data_rast,"x_2100.tif"))/xfactINTS
...
wstar_1990_noneg <- solve_LCP(d = x_1990, wstar = wstar_1990, mask = mask_wstar_1990_nonneg) 
